      ...
      <CForm>
        <CTabs activeItemKey="home">
          <CCard>
            ...
            <CCardBody style={{ height: '60vh' }}>
              <CTabContent>
                <CTabPanel className="p-2" itemKey="home">
                  {/* Nom */}
                  <CRow className="mb-2">
                  ...
                  <CRow className="mb-2">
                    ...
                    <CCol sm={8}>
                      <CFormInput type="text" id="inputPrenom" placeholder="Entrez le prénom" />
                    </CCol>
                  </CRow>
                  ...
                  <CRow className="mb-2">
                    ...
                    <CCol sm={8}>
                      <CInputGroup>
                        ...
                        <CFormInput placeholder="Entrez les 10 chiffres" type="number" min={0} />
                      </CInputGroup>
                    </CCol>
                  </CRow>
                  ...
                  <CRow className="mb-2">
                    ...
                    <CCol sm={8}>
                      <CInputGroup>
                        <CFormInput placeholder="Entrez le numéro de la pièce" type="text" />
                      </CInputGroup>
                    </CCol>
                  </CRow>
                </CTabPanel>
                <CTabPanel className="p-2" itemKey="profile">
                  <CRow className="mb-2">
                ...
                <CTabPanel className="p-2" itemKey="contact">
                  <div className="text-center">
                    <img src={success} alt="Lock Icon" width="100" height="100" />
                    <div>
                      Félicitation, Monsieur{' '}
                      <span style={{ color: 'green', fontWeight: 'bold' }}>Michael Kouame</span> a
                      été succès
                    </div>
                    ...
                    >
                      <span className="text-warning">Code de connexion a usage unique</span>
                      <div>
                        <img
        ...
        <div className="mt-3 text-center">
          <CButton color="warning" style={{ width: '50%' }}>
            Enregistrer
          </CButton>
        </div>
      </CForm>
